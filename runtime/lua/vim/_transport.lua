...
---
--- @class (private) vim.TransportRun : vim.Transport
--- @field cmd string[] Command to start the process.
--- @field extra_spawn_params? vim.transport.ExtraSpawnParams
--- @field sysobj? vim.SystemObj
local TransportRun = {}

--- @param cmd string[] Command to start the process.
--- @param extra_spawn_params? vim.transport.ExtraSpawnParams
--- @return vim.TransportRun
...
---
--- @class (private) vim.TransportConnect : vim.Transport
